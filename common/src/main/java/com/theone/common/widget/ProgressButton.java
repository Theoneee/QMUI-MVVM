...
public class ProgressButton extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_color, Color.parseColor("#6699ff"));
        mBackgroundSecondColor = a.getColor(R.styleable.ProgressButton_progressbtn_backgroud_second_color, Color.LTGRAY);
