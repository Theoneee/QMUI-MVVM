...
public class DateTimePicker {
    ...
    private void initDialog(Context context) {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.common_date_time_picker_layout);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            title = context.getString(R.string.date_picker_title);
            cancel = context.getString(android.R.string.cancel);
            ok = context.getString(android.R.string.ok);
            year = context.getString(R.string.date_picker_year);
            month = context.getString(R.string.date_picker_month);
            day = context.getString(R.string.date_picker_day);
            hour = context.getString(R.string.date_picker_hour);
            minute = context.getString(R.string.date_picker_minute);
